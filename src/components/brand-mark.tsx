  ...
  return (
    <div className={cn("flex items-center justify-center", className)}>
      ...
      >
        ...
        <path d="M5,12 V37 C5,41 11,43 18,43 C25,43 31,41 31,37 V12 Z" fill="#E8DCC8" stroke="#6B8C6F" strokeWidth="1.3" strokeLinejoin="round" />
        {/* Top lid */}
        <ellipse cx="18" cy="12" rx="13" ry="4" fill="#E8DCC8" stroke="#6B8C6F" strokeWidth="1.3" />
        {/* Lid inner rim */}
        <ellipse cx="18" cy="12" rx="10.5" ry="2.5" fill="none" stroke="#F4EDE3" strokeWidth="0.7" />
        {/* Dog face */}
